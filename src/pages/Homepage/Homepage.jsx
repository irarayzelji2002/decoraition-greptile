...
import TooltipWithClickAway from "../../components/TooltipWithClickAway.jsx";
import CustomTooltip, { DescriptionTooltip } from "../../components/CustomTooltip.jsx";
...
function Homepage() {
  ...
  const [infoDesign, setInfoDesign] = useState(false);
  const [infoProject, setInfoProject] = useState(false);

  const [openDesignTooltip, setOpenDesignTooltip] = useState(false);
  const [openProjectTooltip, setOpenProjectTooltip] = useState(false);
  const [designsTooltipClickLocked, setDesignsTooltipClickLocked] = useState(false);
  const [projectsTooltipClickLocked, setProjectsTooltipClickLocked] = useState(false);
        ...
        <section className="recent-section">
          <div className="recent-designs">
            <div className="separator">
              {/* <DesignSvg /> */}
              <h2 style={{ textAlign: "center" }} ref={recentDesignsRef}>{`${
                searchQuery ? "Searched" : "Recent"
              } Designs`}</h2>{" "}
              <TooltipWithClickAway
                open={openDesignTooltip}
                setOpen={setOpenDesignTooltip}
                tooltipClickLocked={designsTooltipClickLocked}
                setTooltipClickLocked={setDesignsTooltipClickLocked}
                title={
                  <DescriptionTooltip description="Designs are individual works to be modified/generated by AI, press the create design to make one now!" />
                }
                className="helpTooltip"
              >
                <HelpOutlineIcon sx={{ color: "var(--iconDark)" }} />
              </TooltipWithClickAway>
        ...
        <section className="recent-section">
          <div className="recent-designs">
            <div className="separator">
              ...
              >{`${searchQuery ? "Searched" : "Recent"} Projects`}</h2>{" "}
              <TooltipWithClickAway
                open={openProjectTooltip}
                setOpen={setOpenProjectTooltip}
                tooltipClickLocked={projectsTooltipClickLocked}
                setTooltipClickLocked={setProjectsTooltipClickLocked}
                title={
                  <DescriptionTooltip description="Projects are a collection of designs, click the create a project then import your works or create one inside." />
                }
                className="helpTooltip"
              >
                <HelpOutlineIcon sx={{ color: "var(--iconDark)" }} />
